...
void TWAI_main_task(void* parameter) {
  ...
  while (1) {
    ...
    #ifdef DEBUG_FRAMES
      Serial.printf("TWAI[rx]: Process frame with id=0x%04x.\n\r", (int)frame.identifier);
    #endif
