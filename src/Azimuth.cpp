...
#define JSON_AZIMUTH_LEFT "azimuth-left"
#define JSON_AZIMUTH_RIGHT "azimuth-right"
...
{
    AZIMUTH_init_int(JSON_AZIMUTH_LEFT, 0);
    AZIMUTH_init_int(JSON_AZIMUTH_RIGHT, 5);
}

/********************************************************************
 * Azimuth main loop
 ********************************************************************/
bool AZIMUTH_ENABLED = false;
void AZIMUTH_update()
{
    if(AZIMUTH_ENABLED)
    {
