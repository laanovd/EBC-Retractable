...
void setup(void) {
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request) {
    request->send(200, "text/plain", "Hi! This is ElegantOTA Pro AsyncDemo.");
  });

  // You can also enable authentication by uncommenting the below line.
  // ElegantOTA.setAuth("admin", "password");

  ElegantOTA.setID("test-hardware");  // Set Hardware ID
  ElegantOTA.setFWVersion("1.0.0");   // Set Firmware Version

  ElegantOTA.setTitle("OTA Portal");  // Set OTA Webpage Title
